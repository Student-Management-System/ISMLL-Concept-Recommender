...
class GroupSettingsUpdateDto(object):
    ...
    def __init__(self, allow_groups=None, name_schema=None, size_min=None, size_max=None, selfmanaged=None, auto_join_group_on_course_joined=None, merge_groups_on_assignment_started=None):  # noqa: E501
        """GroupSettingsUpdateDto - a model defined in Swagger"""  # noqa: E501
    ...
    def allow_groups(self, allow_groups):
        """Sets the allow_groups of this GroupSettingsUpdateDto.

        Determines, wether course allows group creation.  # noqa: E501

        :param allow_groups: The allow_groups of this GroupSettingsUpdateDto.  # noqa: E501
        :type: bool
        """
    ...
    def name_schema(self):
        """Gets the name_schema of this GroupSettingsUpdateDto.  # noqa: E501

        If utilized, all group names will use the nameSchema followed by the group's number.  # noqa: E501

        :return: The name_schema of this GroupSettingsUpdateDto.  # noqa: E501
        :rtype: str
        """
    ...
    def name_schema(self, name_schema):
        """Sets the name_schema of this GroupSettingsUpdateDto.

        If utilized, all group names will use the nameSchema followed by the group's number.  # noqa: E501

        :param name_schema: The name_schema of this GroupSettingsUpdateDto.  # noqa: E501
        :type: str
        """
    ...
    @property
    def size_min(self):
        """Gets the size_min of this GroupSettingsUpdateDto.  # noqa: E501

        The required amount of members the group needs in order to submit group-assignments.  # noqa: E501

        :return: The size_min of this GroupSettingsUpdateDto.  # noqa: E501
        :rtype: float
        """
    ...
    def size_min(self, size_min):
        """Sets the size_min of this GroupSettingsUpdateDto.

        The required amount of members the group needs in order to submit group-assignments.  # noqa: E501

        :param size_min: The size_min of this GroupSettingsUpdateDto.  # noqa: E501
        :type: float
        """
    ...
    @property
    def size_max(self):
        """Gets the size_max of this GroupSettingsUpdateDto.  # noqa: E501

        The maximum amount of members in a group.  # noqa: E501

        :return: The size_max of this GroupSettingsUpdateDto.  # noqa: E501
        :rtype: float
        """
    ...
    def size_max(self, size_max):
        """Sets the size_max of this GroupSettingsUpdateDto.

        The maximum amount of members in a group.  # noqa: E501

        :param size_max: The size_max of this GroupSettingsUpdateDto.  # noqa: E501
        :type: float
        """
    ...
    def selfmanaged(self):
        """Gets the selfmanaged of this GroupSettingsUpdateDto.  # noqa: E501

        Indicates, wether the group is managed by its members.  # noqa: E501

        :return: The selfmanaged of this GroupSettingsUpdateDto.  # noqa: E501
        :rtype: bool
        """
    ...
    def selfmanaged(self, selfmanaged):
        """Sets the selfmanaged of this GroupSettingsUpdateDto.

        Indicates, wether the group is managed by its members.  # noqa: E501

        :param selfmanaged: The selfmanaged of this GroupSettingsUpdateDto.  # noqa: E501
        :type: bool
        """
    ...
    def auto_join_group_on_course_joined(self):
        """Gets the auto_join_group_on_course_joined of this GroupSettingsUpdateDto.  # noqa: E501

        If enabled, participants that join the course will automatically join a group.  # noqa: E501

        :return: The auto_join_group_on_course_joined of this GroupSettingsUpdateDto.  # noqa: E501
        :rtype: bool
        """
    ...
    def auto_join_group_on_course_joined(self, auto_join_group_on_course_joined):
        """Sets the auto_join_group_on_course_joined of this GroupSettingsUpdateDto.

        If enabled, participants that join the course will automatically join a group.  # noqa: E501

        :param auto_join_group_on_course_joined: The auto_join_group_on_course_joined of this GroupSettingsUpdateDto.  # noqa: E501
        :type: bool
        """
    ...
    def merge_groups_on_assignment_started(self):
        """Gets the merge_groups_on_assignment_started of this GroupSettingsUpdateDto.  # noqa: E501

        If enabled, groups that don't have enough members will be merged when an assignment starts.  # noqa: E501

        :return: The merge_groups_on_assignment_started of this GroupSettingsUpdateDto.  # noqa: E501
        :rtype: bool
        """
    ...
    def merge_groups_on_assignment_started(self, merge_groups_on_assignment_started):
        """Sets the merge_groups_on_assignment_started of this GroupSettingsUpdateDto.

        If enabled, groups that don't have enough members will be merged when an assignment starts.  # noqa: E501

        :param merge_groups_on_assignment_started: The merge_groups_on_assignment_started of this GroupSettingsUpdateDto.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GroupSettingsUpdateDto, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GroupSettingsUpdateDto):
            return False
